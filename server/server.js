...
function search(searchText){
    let person = personJson.laureates.filter(item => (item.firstname.toUpperCase() === searchText.toUpperCase())||(item.surname&&item.surname.toUpperCase() === searchText.toUpperCase()))
    let searchedResult = []
    let laureatesObject = []
